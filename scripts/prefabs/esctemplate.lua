...
local function onload(inst)
	...
	-- Pee every 10-20 minutes, adding 15% wetness
	inst:DoPeriodicTask((60 * 10) + (math.random() * 60 * 10), function(inst) inst.components.moisture:DoDelta(15) end )

	-- Eat poop
	inst.components.eater:SetDiet({ FOODGROUP.MOO }, { FOODGROUP.MOO })
